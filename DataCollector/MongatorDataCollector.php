...
namespace Mongator\MongatorBundle\DataCollector;
...
/**
 * MongatorDataCollector.
 *
 * @author Pablo Díez <pablodip@gmail.com>
 */
class MongatorDataCollector extends DataCollector
{
    private $logger;
     ...
     * Constructor.
     *
     * @param Mongator\MongatorBundle\Logger\MongatorLogger|null $logger A mongator logger (optional).
     */
    public function __construct(MongatorLogger $logger = null)
    {
        $this->logger = $logger;
    }
